...
Write a Bash script that displays the visitor IP along with the [HTTP status code](/rltoken/Kq-2GaPoUSwJfOGBBWH61Q "HTTP status code") from the Apache log file.
